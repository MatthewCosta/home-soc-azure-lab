...
The lab is being built around Proxmox and will include OPNsense, Active Directory, Windows clients, Wazuh, Kali Linux, vulnerable lab targets, OpenVAS/Greenbone and Microsoft cloud security tools such as Entra ID, Intune, Microsoft Defender and Microsoft Sentinel.
...
| Area | Purpose |
|---|---|
| Infrastructure | Proxmox, OPNsense, DNS, monitoring and core services |
...
| Attack Platform | Kali Linux and controlled security testing |
| Vulnerable Targets | Metasploitable, OWASP Juice Shop, DVWA and isolated vulnerable lab systems |
...
This lab will be built in stages. The earlier stages focus on the core SOC and Microsoft security lab, while the later stages are future learning areas that I plan to work through as the project develops.

1. Lab overview, planning and documentation
2. Proxmox build and infrastructure foundation
3. Network design, firewalling and segmentation
4. Windows Server and Active Directory
5. Azure and Microsoft 365 security
6. SIEM, logging and SOC operations
7. Vulnerability management
8. Attack simulation and isolated security testing
9. Incident response and investigation documentation
10. Automation and scripting
11. Monitoring and operations
12. DevOps, Infrastructure as Code and GitOps
13. Containers and Kubernetes
14. Advanced security engineering
15. Capstone projects and portfolio evidence
